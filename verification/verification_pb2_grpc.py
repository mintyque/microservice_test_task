...
class VerificationsStub(object):
...
class VerificationsServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_VerificationsServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'Verifications', rpc_method_handlers)
...
class Verifications(object):
    ...
    def Verify(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/Verifications/Verify',
